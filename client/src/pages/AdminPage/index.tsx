...
function Main() {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const data = await getAdminAllCountAction(org.id, String(useremail));
      console.log(org,"orgorg");
      console.log(data, "datadatadatadata");
      setOrgName(data[2]?.[0]?.name || "");
      setOrgId(data[2]?.[0]?.id || "");
            ...
            <div className="flex justify-between h-10 intro-y">
              ...
              <div className="flex">
                ...
                <Lucide
                  ...
                  onClick={() => {
                    navigate(
                      `/admin-organisation-settings/${orgId}`
                    );
                  }}
                />
              </div>
