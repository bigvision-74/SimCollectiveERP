...
const { createPaymentIntent, confirmPayment, updatePlan, createSubscription, createCustomer, attachPaymentMethod, getSubscriptionStatus } = require("../controllers/paymentController");
